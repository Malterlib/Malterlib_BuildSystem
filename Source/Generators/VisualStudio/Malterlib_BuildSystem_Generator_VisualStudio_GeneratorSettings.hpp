...
namespace NMib::NBuildSystem::NVisualStudio
{
	...
	TCValueWithPositions<tf_CValue> CGeneratorSetting::f_GetSetting(CStr const &_Name) const
	{
	...
	TCValueWithPositions<tf_CValue> CGeneratorSettings::fsp_GetSingleSetting(tf_CThis &&_This, CStr const &_Name)
	{
		TCValueWithPositions<tf_CValue> ReturnValue;
		bool bFirst = true;
	...
	template <typename tf_CValue>
	TCValueWithPositions<tf_CValue> CGeneratorSettings::f_GetSingleSetting(CStr const &_Name) const &
	{
		return fsp_GetSingleSetting<tf_CValue>(*this, _Name);
	}

	template <typename tf_CValue>
	TCValueWithPositions<tf_CValue> CGeneratorSettings::f_GetSingleSetting(CStr const &_Name) &&
	{
		return fsp_GetSingleSetting<tf_CValue>(fg_Move(*this), _Name);
	}

	template <typename tf_CValue>
	tf_CValue CGeneratorSetting::f_GetSettingWithoutPositions(CStr const &_Name) const
	{
		...
		if constexpr (!cIsOptional<tf_CValue>)
		{
			if (!pValue)
	...
	template <typename tf_CValue>
	tf_CValue CGeneratorSettings::f_GetSingleSettingWithoutPositions(CStr const &_Name) const
	{
		tf_CValue ReturnValue;
		bool bFirst = true;
		CConfiguration const *pFirstConfig;
