...
namespace NMib::NBuildSystem::NRepository
{
		...
		)
	{
		...
		CGitLaunches Launches{_BuildSystem.f_GetBaseDir(), "Filtering repos", _BuildSystem.f_AnsiFlags(), _BuildSystem.f_TerminalWidth(), _BuildSystem.f_OutputConsoleFunctor(), _BuildSystem.f_GetCancelledPointer()};
